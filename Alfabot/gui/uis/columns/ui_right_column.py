...
class Ui_RightColumn(object):
    ...
    def retranslateUi(self, RightColumn):
        ...
        self.label_1.setText(QCoreApplication.translate("RightColumn", u"Menü 3", None))
        self.label_2.setText(QCoreApplication.translate("RightColumn", u"Menu 4", None))
        self.label_3.setText(QCoreApplication.translate("RightColumn", u"Példa2 (jobb oldal).\n", None))
