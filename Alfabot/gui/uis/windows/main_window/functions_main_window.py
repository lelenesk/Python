...
class MainFunctions():
    ...
    def pageshifter_newclient(self):
        MainFunctions.set_page(self,self.ui.load_pages.page_search_new_client)
        print("ujkliens")

    def pageshifter_existing_datamod(self):
        MainFunctions.set_page(self,self.ui.load_pages.page_search_exist_data)
        print("ujadat")
    def pageshifter_existing_new_event(self):
        MainFunctions.set_page(self,self.ui.load_pages.page_search_exist_event)
        print("ujevent")
